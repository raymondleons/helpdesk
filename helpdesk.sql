...
--
-- Host: 127.0.0.1
-- Generation Time: 22 Mar 2018 pada 02.06
...
INSERT INTO `karyawan` (`nik`, `password`, `nama`, `alamat`, `jabatan`, `id_bagian_dept`, `id_jabatan`, `level`) VALUES
('110', 'raymondls1', 'Raymond Leon Sembiring', 'Batam', 'Kepala', 3, 3, 1);
...
INSERT INTO `level_user` (`id_level`, `keterangan`) VALUES
(1, 'Admin'),
(2, 'Karyawan'),
(3, 'Pelapor');
